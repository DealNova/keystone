...
module.exports = function (keystone) {
	function List (key, options) {
		...
		Object.defineProperty(this, 'label', {
			get: function () {
				return (
					this.get('label')
					|| this.set('label', utils.plural(utils.keyToLabel(key)))
				);
			},
		});
		Object.defineProperty(this, 'singular', {
			get: function () {
				return (
					this.get('singular')
					|| this.set('singular', utils.singular(this.label))
				);
			},
		});
		Object.defineProperty(this, 'plural', {
			get: function () {
				return (
					this.get('plural') || this.set('plural', utils.plural(this.singular))
				);
			},
		});
		...
		Object.defineProperty(this, 'nameFieldIsFormHeader', {
			get: function () {
				return this.fields[this.mappings.name]
					&& this.fields[this.mappings.name].type === 'text'
					? !this.fields[this.mappings.name].noedit
					: false;
			},
		});
		Object.defineProperty(this, 'nameIsInitial', {
			get: function () {
				return (
					this.fields[this.mappings.name]
					&& this.fields[this.mappings.name].options.initial === undefined
				);
			},
		});
		Object.defineProperty(this, 'initialFields', {
			get: function () {
				return (
					initialFields
					|| (initialFields = _.filter(this.fields, function (i) {
						return i.initial;
					}))
				);
			},
	...
	Object.defineProperty(List.prototype, 'defaultSort', {
		get: function () {
			...
			return ds === '__default__'
				? this.get('sortable') ? 'sortOrder' : this.namePath
				: ds;
		},
		set: function (value) {
